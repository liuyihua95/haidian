...
1. **为什么是海淀**：基础研究、产业转化、青年人才与真实城市生活在此交汇，具备把 AI 从技术能力转化为公共文明能力的条件。
...
5. **怎样开始**：先补 official 数据并修复空间断点，再启动五个可逆试点，以公开评测和年度复盘决定扩大、修改或退出。
...
![图 16｜十四个场景的六问责任卡](assets/figures/scenario-matrix-v2.png)
